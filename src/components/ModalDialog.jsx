...
const ModalDialog = forwardRef((props, ref) => {
  ...
  return (
    <dialog
      ref={ref}
      className="sm:ml-40 ml-0 backdrop:bg-blue-950/95 bg-slate-500/0 max-h-screen max-w-screen overflow-x-hidden my-10 sm:my-auto sm:overflow-hidden"
    >
      {modelUrl && (
        <div className="flex flex-col sm:flex-row w-screen max-h-screen items-center 2xl:justify-center ">
          <div className="border sm:w-40 sm:h-40 md:w-60 md:h-60 2xl:w-96 2xl:h-96 xl:w-80 xl:h-80">
      ...
      <div className="py-8 xl:mx-64 mx-0 justify-center items-center text-white md:text-2xl text-md font-extrabold font-sans font-outline-2 tracking-[.11em] ">
        <form method="dialog">
          <div className="flex flex-row justify-center items-center sm:mt-0 mt-2 mx-20 my-10 sm:my-0">
